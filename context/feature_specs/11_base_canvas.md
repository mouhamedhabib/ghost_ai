...
- [x] Read the base canvas spec, Liveblocks React Flow guidance, and local Next.js App Router docs.
- [x] Add shared canvas types.
- [x] Create the Liveblocks-backed client canvas wrapper.
- [x] Replace the workspace canvas placeholder.
- [x] Run verification.
