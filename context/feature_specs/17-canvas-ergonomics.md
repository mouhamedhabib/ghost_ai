...
- [x] Read the canvas ergonomics spec and current canvas implementation.
- [x] Added a bottom-left floating control bar with zoom, fit view, undo, and redo controls.
- [x] Wired zoom controls to the React Flow instance with short animated transitions.
- [x] Wired undo/redo controls to Liveblocks history state with disabled states.
- [x] Added `hooks/useKeyboardShortcuts.ts` for zoom and history shortcuts.
- [x] Removed the bottom-right minimap.
- [x] Run `npm run build`.
