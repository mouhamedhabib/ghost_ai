...
- [x] Read spec and relevant local Next.js App Router docs.
- [x] Add project color-token aliases needed by the sidebar UI.
- [x] Separate the AI sidebar into `components/editor/ai-sidebar.tsx` with parent-controlled open/close state.
- [x] Build the AI Workspace header with bot icon, subtitle, and close button.
- [x] Add shadcn tabs for AI Architect and Specs.
- [x] Build the AI Architect empty state, starter chips, message styling, textarea, and submit behavior.
- [x] Build the Specs tab with Generate Spec button and static demo spec card.
- [x] Run `npm run build` and resolve any errors.
