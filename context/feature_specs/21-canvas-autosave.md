...
- [x] `@vercel/blob` is installed.
- [x] Project schema supports storing the canvas blob URL.
- [x] Save/load routes use Prisma for metadata and Vercel Blob for canvas JSON.
- [x] Autosave hook debounces canvas saves.
- [x] Editor shows save status.
- [x] Saved canvas does not load if the room already has
