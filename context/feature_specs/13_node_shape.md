...
- [x] Read the node shape spec, local Next.js client component docs, and Liveblocks React Flow guidance.
- [x] Replace placeholder node rendering with CSS and SVG shape surfaces.
- [x] Add selected-state border treatment for shape nodes.
- [x] Add cursor-following drag preview for shape toolbar drags.
- [x] Keep drop/node creation connected to the existing Liveblocks React Flow state.
