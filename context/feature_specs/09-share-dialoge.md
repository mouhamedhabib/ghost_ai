...
- [x] Read spec, AGENTS.md, relevant Next route/page docs, and Clerk Backend API guidance.
- [x] Add collaborator API routes for list, invite, and remove with server-side ownership checks.
- [x] Enrich collaborator emails with Clerk user display names and avatars when available.
- [x] Add the workspace share dialog and wire it to the navbar Share button.
- [x] Enforce read-only collaborator UI and owner-only invite/remove controls.
- [x] Run `npm run build` and resolve errors.
